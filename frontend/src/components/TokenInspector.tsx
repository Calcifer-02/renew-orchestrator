...
export function TokenInspector({ task, transitions, lockedJob, onFire, onClose }: Props) {
  ...
  return (
    <div style={{
      ...
      {/* Task meta */}
      <div style={{ display: 'flex', flexDirection: 'column', gap: 3, marginBottom: 10, userSelect: 'text' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 5, marginTop: 1 }}>
          <span style={{ width: 42, fontSize: 8, color: '#2d5080', fontFamily: 'JetBrains Mono', flexShrink: 0, paddingTop: 1 }}>цель</span>
      ...
      {transitions.length === 0 ? (
        <div style={{ fontSize: 8.5, color: '#1e3a5f', fontFamily: 'JetBrains Mono', padding: '4px 0' }}>
          {lockedJob ? 'переходы заблокированы активным заданием' : 'нет доступных переходов'}
        </div>
      ) : (
              ...
              <div key={tr.id} style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    letterSpacing: '0.5px', minWidth: 60, textAlign: 'center',
